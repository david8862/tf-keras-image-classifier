...
def SqueezeExcite(input_x, se_ratio=0.25, reduced_base_chs=None, divisor=4, name=None):
    ...
    x = Conv2D(filters=int(input_x.shape[-1]), kernel_size=1, use_bias=True, name=name+'_conv_expand')(x)
...
if __name__ == '__main__':
    ...
    img = image.load_img('../../example/grace_hopper.jpg', target_size=(224, 224))
