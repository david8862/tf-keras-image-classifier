...
with trained CNN classifer model
...
def generate_featuremap(image_path, model_path, model_input_shape, layer_names, featuremap_path):
    ...
    for i, image_file in enumerate(image_list):
        ...
        img = np.array(img)
        image_data = normalize_image(img)
...
def main():
    parser = argparse.ArgumentParser(description='check featuremap activation of specified layer with trained CNN classifer model')
