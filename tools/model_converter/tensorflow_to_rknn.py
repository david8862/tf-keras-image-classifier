...
# -*- coding: utf-8 -*-
"""
Script to convert CNN classifier tensorflow model to RKNN model
...
def main():
    ...
    parser.add_argument('--model_input_shape', type=str, help='model image input shape as <height>x<width>, default=%(default)s', default='224x224')
