...
# -*- coding: utf-8 -*-
"""
Triton grpc client for wenet ASR model inference service
"""
...
def main():
    parser = argparse.ArgumentParser(description='Triton grpc client for WeNet ASR model inference server')
    ...
    parser.add_argument('--model_name', type=str, required=False, choices=["attention_rescoring", "streaming_wenet"], default='attention_rescoring',
